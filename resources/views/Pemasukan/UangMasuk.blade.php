...
{{-- Add modal content --}}
<div id="addModalUangMasuk" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form action="#" method="POST" id="add_uangmasuk_form" class="ps-3 pe-3">
                    @csrf
                    <div class="mb-2">
                    ...
                    <div class="mb-3 text-right">
                        <button type="submit" id="add_uangmasuk_btn" class="ri-send-plane-line btn rounded-pill btn-primary">Add Uang Masuk</button>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#addModalUangMasuk">
                                <i class="mdi mdi-plus-circle"></i> Add Uang Masuk
                            </button>
                        </div>
                        <div class="card-body" id="show_all_uangmasuk">
...
<script>
    $(function() {
        ...
        function fetchAllTransaksi() {
            $.ajax({
                url: `{{ route('fetchAllUangMasuk') }}`,
                method: 'get',
                success: function(res) {
                    $("#show_all_uangmasuk").html(res);
                    $("table").DataTable({
                        order: [0, 'desc']
                    });
                }
